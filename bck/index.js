...
app.use(cors({
    ...
    credentials: true // Разрешить отправку учетных данных // Разрешить запросы с этого источника
}));
var access_token = '';
...
//         res.redirect('https://back-for-Notation Pro .vercel.app/success');
//       })
//     })
...
//             axios({
//                 method: 'post',
//                 url: 'https://back-for-Notation Pro .vercel.app/gitlogin',
//                 data: requestBody
//             }).then((response) => {
